...
function LoginScreen({onLogin}){
  ...
  return(
    <div style={{background:"#111",minHeight:"100vh",display:"flex",justifyContent:"center",alignItems:IS_MOBILE?"flex-start":"center"}}>
      ...
      {IS_MOBILE&&<div style={{background:G.bg,width:"100%",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",minHeight:"100vh",padding:"28px 24px",fontFamily:G.font,color:G.white,textAlign:"center"}}>
