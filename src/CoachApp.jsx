...
const HYPERTRO_CONFIRME = {id:"hypertro_confirme_6s",name:"Hypertrophie Confirmé 6 sem.",category:"Hypertrophie",level:"Confirmé",weeks:[
  // S1 — ACCUMULATION
  {label:"S1 — Accumulation · Mise en route",days:[
    {label:"Séance A — Pectoraux + Triceps",exercises:[
      mkPct(2,4,"12","2min",70,"1rm_bench","Amplitude complète, coudes à 45°, descente 3s"),
      mkEx(25,4,"12","—","Moyen-Lourd","SUPERSET A1 → enchaîner. Inclinaison 30°, faisceau supérieur."),
      mkEx(27,4,"12","90s","","SUPERSET A2 → repos 90s. Arc léger, ne pas descendre trop bas."),
      ...
      mkEx(56,3,"15","75s","","SUPERSET B2 → repos 75s. Coudes serrés, longue portion."),
      mkEx(29,3,"15","60s","","Pec Deck — finisher, contraction maximale en centre"),
    ]},
    {label:"Séance B — Dos + Biceps",exercises:[
      mkPct(4,4,"10","3min",70,"1rm_sdt","Barre proche du corps, dos plat, poussée du sol"),
      mkEx(32,4,"12","—","Moyen","SUPERSET A1 → enchaîner. Coudes vers le bas, omoplates rétractées."),
      mkEx(33,4,"12/côté","90s","","SUPERSET A2 → repos 90s. Dos plat, tirer vers la hanche."),
      mkEx(34,3,"12","—","Moyen","SUPERSET B1 → enchaîner. Serrer les omoplates en fin de mouvement."),
      mkEx(52,3,"12","75s","","SUPERSET B2 → repos 75s. Coudes fixes le long du corps."),
      mkEx(48,3,"12","—","","SUPERSET C1 → enchaîner. Bras perpendiculaires au sol, longue portion."),
      mkEx(51,3,"15","60s","","SUPERSET C2 → repos 60s. Isolation maximale, contraction en haut."),
    ]},
    {label:"Séance C — Jambes + Abdominaux",exercises:[
      ...
      mkEx(18,3,"12","—","Moyen","SUPERSET A1 → enchaîner. Descente à 90°, genoux alignés."),
      mkEx(13,3,"12","90s","","SUPERSET A2 → repos 90s. Hanches plaquées sur le banc."),
      mkEx(15,3,"12","90s","65% RM","Romanian Deadlift — descente jusqu'à tension ischio, dos plat"),
    ...
    {label:"Séance D — Épaules + Bras",exercises:[
      mkEx(5,4,"12","90s","65% RM","Développé Militaire — core serré, regard droit"),
      mkEx(40,4,"15","—","Léger","SUPERSET A1 → enchaîner. Légère flexion des coudes, montée lente."),
      mkEx(42,4,"15","75s","","SUPERSET A2 → repos 75s. Buste penché, coudes légèrement fléchis."),
      mkEx(43,3,"12","—","Moyen","SUPERSET B1 → enchaîner. Coudes au-dessus des poignets."),
      mkEx(37,3,"15","75s","","SUPERSET B2 — Face Pull → repos 75s. Coudes hauts, tirer vers le visage."),
      mkEx(49,3,"12","—","","SUPERSET C1 → enchaîner. Poignets neutres."),
      mkEx(7,3,"15","60s","","SUPERSET C2 → repos 60s. Coudes fixes, extension complète."),
    ]},
  ]},
  // S2 — ACCUMULATION+
  {label:"S2 — Accumulation · Progression charges",days:[
    {label:"Séance A — Pectoraux + Triceps",exercises:[
      ...
      mkEx(25,4,"10","—","Lourd","SUPERSET A1 → enchaîner"),
      mkEx(27,4,"12","90s","","SUPERSET A2 → repos 90s"),
      mkEx(28,4,"Max","90s","","Dips — +1 série vs S1"),
      mkEx(55,4,"10","—","","SUPERSET B1 → enchaîner"),
      mkEx(56,4,"12","75s","","SUPERSET B2 → repos 75s"),
      mkEx(29,3,"15","60s","","Pec Deck — finisher"),
    ]},
    {label:"Séance B — Dos + Biceps",exercises:[
      mkPct(4,4,"8","3min",73,"1rm_sdt","Charge progressive vs S1"),
      mkEx(32,4,"10","—","Moyen-Lourd","SUPERSET A1 → enchaîner"),
      mkEx(33,4,"10/côté","90s","","SUPERSET A2 → repos 90s"),
      mkEx(34,4,"12","—","Moyen","SUPERSET B1 → enchaîner"),
      mkEx(52,4,"10","75s","","SUPERSET B2 → repos 75s"),
      mkEx(48,3,"10","—","","SUPERSET C1 → enchaîner"),
      mkEx(51,3,"12","60s","","SUPERSET C2 → repos 60s"),
    ]},
    {label:"Séance C — Jambes + Abdominaux",exercises:[
      mkPct(1,4,"10","3min",73,"1rm_squat","Charge progressive vs S1"),
      mkEx(11,4,"10","2min","Lourd","Leg Press — progression charges"),
      mkEx(18,4,"10","—","Moyen-Lourd","SUPERSET A1 → enchaîner"),
      mkEx(13,4,"12","90s","","SUPERSET A2 → repos 90s"),
      mkEx(15,4,"10","90s","70% RM","RDL — charge progressive, focus excentrique"),
    ...
    {label:"Séance D — Épaules + Bras",exercises:[
      ...
      mkEx(40,4,"12","—","Léger-Moyen","SUPERSET A1 → enchaîner"),
      mkEx(42,4,"12","75s","","SUPERSET A2 → repos 75s"),
      mkEx(43,4,"10","—","Moyen","SUPERSET B1 → enchaîner"),
      mkEx(37,3,"15","75s","","SUPERSET B2 → repos 75s"),
      mkEx(49,4,"10","—","","SUPERSET C1 → enchaîner"),
      mkEx(7,4,"12","60s","","SUPERSET C2 → repos 60s"),
    ]},
  ]},
  // S3 — INTENSIFICATION
  {label:"S3 — Intensification · Charges lourdes",days:[
    {label:"Séance A — Pectoraux + Triceps",exercises:[
      ...
      mkEx(25,4,"8","—","Lourd","SUPERSET A1 → enchaîner"),
      mkEx(27,4,"10","90s","","SUPERSET A2 → repos 90s"),
      mkEx(28,4,"Max","90s","","Dips — ajouter lest si plus de 12 reps propres"),
      mkEx(58,4,"8","—","Moyen-Lourd","SUPERSET B1 — Close Grip → enchaîner. Prise serrée, coudes le long du corps."),
      mkEx(59,4,"12","75s","","SUPERSET B2 — Corde Poulie → repos 75s. Écarter la corde en bas."),
      mkEx(31,3,"15","60s","","Cable Crossover — finisher, mains se croisent en bas"),
    ]},
    {label:"Séance B — Dos + Biceps",exercises:[
      mkPct(4,4,"6","3min",77,"1rm_sdt","Charge lourde — rigueur technique absolue"),
      mkEx(3,4,"Max","2min","","Tractions — descendre jusqu'à extension complète"),
      mkEx(10,4,"8","—","Lourd","SUPERSET A1 — Rowing Barre → enchaîner. Dos parallèle, coudes hauts."),
      mkEx(34,4,"10","90s","","SUPERSET A2 → repos 90s"),
      mkEx(47,4,"10","—","Moyen-Lourd","SUPERSET B1 — Curl Barre → enchaîner. Coudes fixes."),
      mkEx(50,4,"12","75s","","SUPERSET B2 — Curl Poulie Basse → repos 75s. Tension constante."),
      mkEx(38,3,"12","90s","Lourd","Shrugs — élévation verticale, pause 2s en haut"),
    ]},
    {label:"Séance C — Jambes + Abdominaux",exercises:[
      mkPct(1,5,"6","3min",80,"1rm_squat","Pic de charge — +1 série. Sortie explosive."),
      mkEx(11,4,"8","2min","Lourd","Leg Press — charges lourdes"),
      mkEx(18,4,"8","—","Lourd","SUPERSET A1 → enchaîner"),
      mkEx(13,4,"10","90s","Lourd","SUPERSET A2 → repos 90s"),
      mkEx(15,4,"8","90s","75% RM","RDL — tension excentrique max, descente 4s"),
    ...
    {label:"Séance D — Épaules + Bras",exercises:[
      ...
      mkEx(45,4,"10","—","Moyen","SUPERSET A1 — Développé Haltères Assis → enchaîner"),
      mkEx(40,4,"12","75s","Moyen","SUPERSET A2 → repos 75s"),
      mkEx(42,4,"12","—","","SUPERSET B1 → enchaîner"),
      mkEx(37,4,"15","75s","","SUPERSET B2 → repos 75s"),
      mkEx(47,4,"10","—","Lourd","SUPERSET C1 — Curl Barre → enchaîner"),
  ...
  {label:"S4 — Intensification · Volume lourd",days:[
    {label:"Séance A — Pectoraux + Triceps",exercises:[
      mkPct(2,5,"6","2min",80,"1rm_bench","Pic de volume — 5 séries. Phase excentrique 3s."),
      mkEx(24,4,"8","—","Lourd","SUPERSET A1 — Développé Couché Haltères → enchaîner. Rotation poignets en haut."),
      mkEx(27,4,"12","90s","","SUPERSET A2 → repos 90s. Étirement max en bas."),
      mkEx(28,4,"Max","90s","Lest","Dips — lest si >12 reps. Corps penché en avant."),
      mkEx(58,4,"6","—","Lourd","SUPERSET B1 → enchaîner"),
      mkEx(59,4,"15","75s","","SUPERSET B2 → repos 75s"),
      mkEx(31,3,"12","60s","","Cable Crossover — contraction et étirement maximaux"),
    ]},
    {label:"Séance B — Dos + Biceps",exercises:[
      mkPct(4,5,"5","3min",82,"1rm_sdt","Pic de charge — 5 séries. Rigueur technique."),
      mkEx(3,5,"Max","2min","","Tractions — ajouter lest si plus de 10 reps propres"),
      mkEx(10,4,"8","—","Très lourd","SUPERSET A1 → enchaîner"),
      mkEx(34,4,"10","90s","","SUPERSET A2 → repos 90s"),
      mkEx(47,4,"8","—","Lourd","SUPERSET B1 → enchaîner"),
      mkEx(50,4,"12","75s","","SUPERSET B2 → repos 75s"),
      mkEx(38,3,"12","90s","Très lourd","Shrugs — pause 2s en haut"),
    ]},
    {label:"Séance C — Jambes + Abdominaux",exercises:[
      mkPct(1,5,"5","3min",82,"1rm_squat","Pic de charge. Sortie explosive, descente 3s."),
      mkEx(11,5,"8","2min","Très lourd","Leg Press — pic de volume"),
      mkEx(18,4,"6","—","Très lourd","SUPERSET A1 → enchaîner"),
      mkEx(13,4,"10","90s","Lourd","SUPERSET A2 → repos 90s"),
      mkEx(15,4,"6","90s","77% RM","RDL — charge maximale, excentrique 4s"),
      mkEx(12,4,"10","—","Lourd","SUPERSET B1 — Drop set sur la dernière série → enchaîner"),
      mkEx(19,4,"20","60s","","SUPERSET B2 → repos 60s"),
    ]},
    {label:"Séance D — Épaules + Bras",exercises:[
      mkEx(5,5,"6","90s","80% RM","Développé Militaire — pic de charge, +1 série"),
      mkEx(45,4,"8","—","Lourd","SUPERSET A1 → enchaîner"),
      mkEx(40,4,"12","75s","Moyen","SUPERSET A2 → repos 75s"),
      mkEx(42,4,"12","—","","SUPERSET B1 → enchaîner"),
      mkEx(37,4,"15","75s","","SUPERSET B2 → repos 75s"),
  ...
  {label:"S5 — Pic · Intensité maximale",days:[
    {label:"Séance A — Pectoraux + Triceps",exercises:[
      mkPct(2,4,"5","3min",85,"1rm_bench","Très lourd — sécurité parades obligatoires. Technique parfaite."),
      mkEx(24,4,"6","—","Très lourd","SUPERSET A1 → enchaîner. Drop set sur la 4e série."),
      mkEx(27,4,"12","90s","","SUPERSET A2 → repos 90s"),
      mkEx(28,3,"Max","2min","Lest","Dips — aller à l'échec sur la dernière série"),
      mkEx(58,4,"6","—","Lourd","SUPERSET B1 → enchaîner"),
      mkEx(7,4,"15","75s","","SUPERSET B2 → repos 75s"),
      mkEx(29,3,"15","45s","","Pec Deck — finisher, rest-pause possible"),
    ]},
    {label:"Séance B — Dos + Biceps",exercises:[
      mkPct(4,5,"4","4min",85,"1rm_sdt","Charge maximale — 5 séries. Échauffement prolongé conseillé."),
      mkEx(3,5,"Max","2min","","Tractions — lest si >10 reps. Dernière série à l'échec."),
      mkEx(10,4,"6","—","Très lourd","SUPERSET A1 → enchaîner"),
      mkEx(33,4,"8/côté","90s","Lourd","SUPERSET A2 → repos 90s"),
      mkEx(52,4,"8","—","Lourd","SUPERSET B1 — Curl EZ → enchaîner"),
      mkEx(50,4,"12","75s","","SUPERSET B2 → repos 75s. Drop set sur la dernière série."),
      mkEx(38,3,"10","90s","Très lourd","Shrugs — pause 3s en haut"),
    ]},
    {label:"Séance C — Jambes + Abdominaux",exercises:[
      mkPct(1,5,"4","4min",85,"1rm_squat","Charge maximale. Sécurité parades. Sortie explosive."),
      mkEx(11,5,"6","2min","Très lourd","Leg Press — pic de charge. Drop set sur la 5e série."),
      mkEx(18,4,"6","—","Très lourd","SUPERSET A1 → enchaîner"),
      mkEx(13,4,"8","90s","Très lourd","SUPERSET A2 → repos 90s"),
      mkEx(15,4,"6","2min","80% RM","RDL — charge max, excentrique 4s"),
      mkEx(12,4,"10","—","Lourd","SUPERSET B1 — Drop set sur la dernière série → enchaîner"),
      mkEx(19,4,"20","60s","","SUPERSET B2 → repos 60s"),
    ]},
    {label:"Séance D — Épaules + Bras",exercises:[
      ...
      mkEx(45,4,"8","—","Lourd","SUPERSET A1 → enchaîner"),
      mkEx(40,4,"12","75s","Moyen","SUPERSET A2 → repos 75s. Drop set sur la dernière série."),
      mkEx(44,4,"12","—","Léger-Moyen","SUPERSET B1 — Élévations Frontales → enchaîner"),
  ...
  {label:"S6 — Deload · Récupération & consolidation",days:[
    {label:"Séance A — Pectoraux + Triceps",exercises:[
      ...
      mkEx(27,3,"12","90s","","SUPERSET A2 → repos 90s"),
      mkEx(56,3,"15","—","Léger","SUPERSET B1 → enchaîner"),
      mkEx(57,3,"15","75s","","SUPERSET B2 → repos 75s"),
      mkEx(29,2,"15","60s","","Pec Deck — récupération active"),
    ]},
    {label:"Séance B — Dos + Biceps",exercises:[
      mkPct(4,3,"8","2min",60,"1rm_sdt","Deload — léger, focus mobilité et technique"),
      ...
      mkEx(49,3,"15","60s","Léger","SUPERSET B2 → repos 60s"),
    ]},
    {label:"Séance C — Jambes + Abdominaux",exercises:[
      mkPct(1,3,"10","2min",60,"1rm_squat","Deload — profondeur et technique, pas de charge"),
      mkEx(11,3,"12","90s","Léger","Leg Press — volume réduit"),
      mkEx(15,3,"12","90s","Léger","RDL — focus mobilité ischio"),
      mkEx(13,3,"15","—","Léger","SUPERSET A1 → enchaîner"),
      mkEx(12,3,"15","60s","Léger","SUPERSET A2 → repos 60s"),
      mkEx(19,3,"20","60s","","Mollets — récupération active"),
    ]},
    {label:"Séance D — Épaules + Bras",exercises:[
      mkEx(5,3,"12","90s","Léger","Développé Militaire — charges légères, focus technique"),
      mkEx(40,3,"15","—","Léger","SUPERSET A1 → enchaîner"),
      mkEx(42,3,"15","75s","Léger","SUPERSET A2 → repos 75s"),
      mkEx(6,3,"15","—","Léger","SUPERSET B1 → enchaîner"),
